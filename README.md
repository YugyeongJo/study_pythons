...
| 구분 | 학습 내용 |
| -- | -- |
| **기초 구문** | Python의 기초 구문, 조건문, 반복문, 컴프리헨션을 학습하며 기본적인 프로그램 구조와 제어 흐름을 이해합니다. |
| **데이터 타입** | Boolean, String, Numeric, List, Dictionary와 같은 다양한 데이터 타입을 배우고, 데이터 타입 간 변환과 리스트, 딕셔너리의 활용을 학습합니다. |
| **함수** | 함수의 기본 구조, 파라미터, 반환값, 람다 함수, 콜백 함수 등을 다루며, 함수의 재사용성과 유연한 프로그래밍 방법을 익힙니다. |
| **클래스** | Python에서 객체 지향 프로그래밍(OOP)의 핵심인 클래스 개념을 익히고, RPG 게임 예제 등을 통해 실습합니다. |
| **유용한 기능** | 예외 처리, 파라미터 전달 방식(kwargs), range 활용|
| **퀘스트** | 다양한 문제를 통한 Python 기본 구문과 로직 설계 연습(예시: 구구단, BMI 계산기, 다중 계산기 등)|
| **코딩 테스트** | 백준 및 프로그래머스 문제 풀기|
